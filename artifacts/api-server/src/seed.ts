...
Read the full piece on JourneyBytes.`,
  ...
  await db.insert(events).values([
    ...
    {
      title: "Humanity + AI Podcasts: AI & Advertising — feat. Vasu Raj Jain",
      description: "Board director Vasu Raj Jain joins Humanity + AI, Inc. for a deep dive into AI and advertising. As a Senior SDE at Amazon Ads building large-scale ad serving infrastructure and an IAB Tech Lab contributor, Vasu unpacks how agentic AI, real-time bidding, and machine learning are transforming the future of advertising and media — and what responsible, human-centered advertising looks like in an AI-driven world.",
      date: "2026-07-24",
      time: "5:00 PM Eastern",
      location: "Online — Join Virtually",
      type: "Podcast",
      imageUrl: "/uploads/vasu-raj-jain.jpg",
      secondaryImageUrl: null,
      link: "https://riverside.com/studio/danielle-franklins-studio-dy1Ck?t=ad2d1c7c94b95c266294",
      recordingUrl: null,
      speakerName: "Vasu Raj Jain",
      speakerProfileUrl: "/about/board/vasu-raj-jain",
    },
    {
