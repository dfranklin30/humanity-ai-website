...
const programs: Program[] = [
  {
    ...
    highlights: ["TalkingDOG multi-sensor smart collar", "ROSIE engine & 40-state CER taxonomy", "Real-time signal-to-language translation", "Hardware-agnostic SaaS / API platform"],
    people: [{ slug: "danielle-franklin", role: "Founder & Principal Investigator" }],
    links: [{ label: "ROSIE × TalkingDOG", url: "https://rosie-talkingdog-doolittlecorp.replit.app" }, { label: "Doolittle Corporation", url: "https://doolittlecorp.replit.app" }],
