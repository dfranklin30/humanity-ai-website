...
export function EditorialMasthead({
  ...
  return (
    <header
      className="relative isolate overflow-hidden bg-[#0a2117] text-[#FAF9F6] py-14 md:py-20 px-4 md:px-8"
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-[#0a2117]" />
      </div>

      <div className="max-w-[1400px] mx-auto flex flex-col items-center justify-center space-y-5 text-center">
        <div className="text-[11px] font-semibold tracking-[0.24em] uppercase text-[#6ee7b7] flex items-center gap-2">
          <span className="h-px w-6 bg-[#6ee7b7]/50" />
          {kicker}
          <span className="h-px w-6 bg-[#6ee7b7]/50" />
        </div>
        <h1
          className="font-serif text-4xl md:text-6xl lg:text-7xl leading-[0.95] tracking-tight text-center font-bold text-[#FAF9F6]"
          data-testid="text-page-masthead"
        >
          {title}
        </h1>
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] sm:text-xs font-medium text-[#FAF9F6]/70 uppercase tracking-[0.2em] border-t border-b border-[#FAF9F6]/20 py-2.5 w-full max-w-3xl">
          <span>{issue}</span>
